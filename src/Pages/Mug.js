...
https://isankalpa.org/  */}
            ...
            <ReactPlayer className='course_video '
                width="90%"
                height="30rem"
                url="https://www.youtube.com/embed/wvXNsjfvcSs"
                controls
            ...
            <div className='m-auto flex items-center justify-center'>
                <a href="https://isankalpa.org/">  <button className="bg-rose-300 hover:bg-rose-500 text-[10px] text-white  p-1 rounded mx-2 my-5 m-auto">
                    Ishwar Sankalpa provides vocational education to its students and sells products made by them. Support them by donating
                </button></a>
            </div>
            {videoCompleted && (
